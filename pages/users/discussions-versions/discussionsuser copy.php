...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-6 discussion-body">
                ...
                <button class="btn btn-danger btn-delete" onclick="deleteDiscussion()">Delete Discussion</button>
            </div>
        </div>
    </div>
    ...
    function addComment() {
        ...
        if (commentText.trim() !== '') {
            ...
            <?php if (isset($_SESSION['user_fullname'])) : ?>
                commentElement.innerHTML = '<p class="discussion-comment"><strong><?php echo $_SESSION['user_fullname']; ?>:</strong> ' + commentText + ' <a href="#" onclick="editComment(this)">Edit</a></p>';
            <?php endif; ?>
    ...
    function saveEditedComment(commentContainer, editLink, editCommentInput, saveChangesButton) {
        ...
        commentContainer.innerHTML = '<p class="discussion-comment"><strong><?php echo $_SESSION['user_fullname']; ?>:</strong> ' + editedText + ' <a href="#" onclick="editComment(this)">Edit</a></p>';
    ...
    function deleteDiscussion() {
        // Check if the user is logged in
        <?php if (isset($_SESSION['user_fullname'])) : ?>
            // Find the comment container of the logged-in user
            var userCommentContainer = document.querySelector('.comment:contains("<?php echo $_SESSION['user_fullname']; ?>")');

            // Remove the user's comment if found
