...
function containsSwearWords($text) {
    $swearWords = array("fuck", "Fuck", "Bitch", "bitch", "Nigga", "Nigger", "Shit", "shit", "Bastard", "bastard"); // Add your list of inappropriate words
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-6">
            <?php if (isset($_GET['view_discussion_id'])) : ?>
                ...
                <div class="comment-container" id="commentContainer">
                    ...
                    <a href="discussionsuser.php" class="btn btn-primary mb-3">Back</a>
                        ...
                        if (mysqli_stmt_prepare($stmtFetchDiscussion, $sqlFetchDiscussion)) {
                            ...
                            $discussionDetails = mysqli_fetch_assoc($resultDiscussion);
                             ...
                             echo '<p class="discussion-topic">' . htmlspecialchars($discussionDetails['discussion_topic']) . '</p>';
                             echo '<p class="disscussion-thoughts">' . htmlspecialchars($discussionDetails['thoughts']) . '</p>';
                    ...
                    <form id="addCommentForm" method="post">
                        ...
                        <button type="submit" class="btn-add-comment-with-image" name="addCommentButton">
                    ...
                    <?php if (isset($_POST['addCommentButton']) && $_POST['discussionId'] == $viewingDiscussionId) : ?>
                        <div class="mb-2">
                            <?php if (isset($_SESSION['user_fullname'])) : ?>
                                ...
                                <p><?php echo htmlspecialchars($commentText); ?></p>
            ...
            <?php else : ?>
                ...
                <form id="startDiscussionForm" method="post" class="comment-form">
